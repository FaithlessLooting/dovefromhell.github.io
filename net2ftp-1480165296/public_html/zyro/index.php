...
error_reporting(E_ALL); @ini_set('display_errors', true);
	...
	$forms = array(
		'1'	=> array(
			'e2ed607c' => Array( 'email' => 'matthew.dove13@gmail.com', 'subject' => 'Inquiry from the web page', 'sentMessage' => 'Form was sent.', 'smtpEnable' => false, 'smtpHost' => null, 'smtpPort' => null, 'smtpEncryption' => null, 'smtpUsername' => null, 'smtpPassword' => null, 'fields' => array( array( 'fidx' => '0', 'name' => 'Name', 'type' => 'input', 'options' => '' ), array( 'fidx' => '1', 'name' => 'E-mail', 'type' => 'input', 'options' => '' ), array( 'fidx' => '2', 'name' => 'Message', 'type' => 'textarea', 'options' => '' ) ) )
		)
	);
	$langs = null;
	$def_lang = null;
	...
	$base_url = '/';
	$user_domain = 'doveydovedove.xyz';
	$show_comments = false;
	include dirname(__FILE__).'/functions.inc.php';
	$home_page = '1';
	list($page_id, $lang) = parse_uri();
	$user_key = "x/V3KOrrP1Dp7paYmN9mheg=";
	$user_hash = "a541f0bb9801ce3c";
