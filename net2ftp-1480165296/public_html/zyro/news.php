...
<head>
	...
	<link href="css/news.css?ts=1450195006" rel="stylesheet" type="text/css" />
...
<div id="wb_element_instance25" class="wb_element"><div class="wb-stl-footer" style="white-space: nowrap;">Member of <i class="icon-wb-logo"></i><a href="http://zyro.com/examples/" target="_blank" title="Zyro - Website Builder">Zyro</a></div><script type="text/javascript">
				var _siteProBadge = _siteProBadge || [];
				_siteProBadge.push({hash: "1e642c1d50425c559ce5cb37796b9f0a", cont: "wb_element_instance25"});
				...
				</script></div><div id="wb_element_instance26" class="wb_element" style="width: 100%;">
			<?php
